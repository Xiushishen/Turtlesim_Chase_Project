...
public:
    LedPanelNode() : Node("led_panel"), led_states_(3,0)
    {
        ...
        led_state_publisher_ = this->create_publisher<my_robot_interfaces::msg::LedStateArray>("led_states", 10);

        led_states_timer_ = this->create_wall_timer(std::chrono::seconds(4),
...
private:
    ...
    rclcpp::Publisher<my_robot_interfaces::msg::LedStateArray>::SharedPtr led_state_publisher_;
