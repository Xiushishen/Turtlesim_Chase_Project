...
public:
    NumberCounterNode() : Node("number_counter"), counter_(0)
    {
        ...
        number_subscriber_ = this->create_subscription<example_interfaces::msg::Int64>("number", 10,
                            std::bind(&NumberCounterNode::callbackNumberCounter, this, _1));
        reset_number_server_ = this->create_service<example_interfaces::srv::SetBool>(
            "reset_counter",
            std::bind(&NumberCounterNode::callbackSetCounterZero, this, _1, _2));
        RCLCPP_INFO(this->get_logger(), "Number Counter has been started.");
    }
private:

    void callbackSetCounterZero(const example_interfaces::srv::SetBool::Request::SharedPtr request,
    ...
    rclcpp::Service<example_interfaces::srv::SetBool>::SharedPtr reset_number_server_;
    int counter_;
};
